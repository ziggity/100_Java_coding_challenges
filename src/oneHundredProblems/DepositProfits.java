...
public class DepositProfits {
	...
	public static void main(String[] args) {
		...
		System.out.println(depositProfits(depo, rate, threshold));
	}

	private static double depositProfits(double deposit, double rate, double threshold) {
		double year = 0;
