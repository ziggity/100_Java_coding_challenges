...
public class CompareInts {
	...
	public static void main(String[] args) {
		...
		System.out.println(compareInts("1000", "1000"));
	}

	private static String compareInts(String a, String b) {
		return Integer.parseInt(a) > Integer.parseInt(b) ? "greater" : Integer.parseInt(a) < Integer.parseInt(b)  ? "less" : "equal";
	}
