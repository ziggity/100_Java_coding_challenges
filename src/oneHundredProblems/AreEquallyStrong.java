...
public class AreEquallyStrong {
	...
	public static void main(String[] args) {
		...
		System.out.println(equallyStrong(10, 15, 10, 15));
		System.out.println(equallyStrong(10, 15, 9, 15)); //false
		
	}

	private static boolean equallyStrong(int yourLeft, int yourRight, int friendsLeft, int friendsRight) {
